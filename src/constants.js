...
// Universal Waterfall - ordered fallback chain
// Regardless of requested model, always try in this order:
// 1. claude-opus-4-5-thinking (Opus)
// 2. gemini-3-pro-high (Pro High)
// 3. gemini-3-pro-image (Pro Image)
// 4. gemini-3-flash (Flash)
// Ignores 2.5 models entirely
